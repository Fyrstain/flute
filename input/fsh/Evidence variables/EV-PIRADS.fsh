...
* characteristic[=].definitionExpression.description = "The expression to retrieve PI-RADS score from observation codes"
* characteristic[=].definitionExpression.language = #text/fhirpath
* characteristic[=].definitionExpression.expression = "Observation.code.where(system='http://snomed.info/sct' and code='52988006').value.toInteger()"
