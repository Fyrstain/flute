...
* characteristic[+].description = "PSA(Prostate-specific antigen)"
* characteristic[=].definitionExpression.description = "The expression to retrieve PSA value"
* characteristic[=].definitionExpression.language = #text/fhirpath
* characteristic[=].definitionExpression.expression = "Observation.code.where(system='http://loinc.org' and code='LP18193-0').value as Quantity"
